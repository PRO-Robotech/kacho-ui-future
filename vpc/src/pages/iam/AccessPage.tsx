...
// - CTA «Настроить доступ» → InviteModal с Cascader-ролями и invite-fallback.
  ...
  return (
    <Space direction="vertical" size={16} style={{ width: "100%" }}>
      ...
      <Space size={12} wrap>
        ...
        />
        <Button type="primary" icon={<PlusOutlined />} onClick={() => setInviteOpen(true)} disabled={!resourceId}>
          Настроить доступ
        </Button>
      </Space>
...
function InviteModal({ open, onClose, accountId, projectId, scope }: InviteModalProps) {
  ...
  return (
    <Modal
      ...
      okText={magicLink ? "Готово" : "Сохранить"}
      cancelText="Отмена"
      width={860}
      destroyOnClose
    >
